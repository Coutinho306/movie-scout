...
Provides deterministic detection of exact-title collisions (e.g. four films
all named "Obsession") and resolution of a user's free-text year reference to
a single tmdb_id — both without any LLM call.
...
def detect_title_collision(
    ...
    *,
    ...
    # Step 3: deterministic exact-title lookup (no embedding, no LLM)
